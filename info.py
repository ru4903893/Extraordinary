...
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002403428879'))
...
LOG_API_CHANNEL = int(environ.get('LOG_API_CHANNEL', '-1002403428879'))  
BIN_CHANNEL = int(environ.get('BIN_CHANNEL','0'))
DELETE_CHANNELS = int(environ.get('DELETE_CHANNELS','0'))
LOG_VR_CHANNEL = int(environ.get('LOG_VR_CHANNEL', '-1002403428879'))
auth_channel = environ.get('AUTH_CHANNEL', '-1001817427847')
SUPPORT_GROUP = int(environ.get('SUPPORT_GROUP', '0'))
request_channel = environ.get('REQUEST_CHANNEL', '0')
MOVIE_UPDATE_CHANNEL = int(environ.get('MOVIE_UPDATE_CHANNEL', '0'))
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'https://t.me/OtttHDFlix') #Support group link ( make sure bot is admin )
#---------------------------------------------------------------
#---------------------------------------------------------------
...
if 'DYNO' in environ:
    ...
    ON_HEROKU = False
URL = environ.get("FQDN", "national-rosaleen-hassanaly4203-9a57d1bd.koyeb.app/")
